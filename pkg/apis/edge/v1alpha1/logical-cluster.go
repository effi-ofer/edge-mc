...
type LogicalClusterSpec struct {
	...
	// IsManagedCluster identifies whether a cluster is managed (true) or unmanaged (false)
	// +kubebuilder:default=true
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="IsManagedCluster is immutable"
	IsManagedCluster bool `json:"IsManagedCluster"`
}
